  ...
  ({
    ...
    return (
      <button
        ...
        className={`relative block p-0 outline-none w-6 h-6 md:w-6 md:h-6 rounded-[3px] border cursor-default animate-pulse-fade-in opacity-0
        ...
        <div className="bg-bg/80 border border-border/80 rounded-3xl p-6 md:p-10 shadow-2xl backdrop-blur max-w-[1000px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between border-t border-border/50 pt-6 gap-6 px-2">
            ...
            <div className="flex items-center gap-2 font-mono text-[11px] text-fg-muted uppercase tracking-widest">
              <span>Less</span>
              <div className="w-6 h-6 md:w-6 md:h-6 rounded-[3px] bg-bg border border-border/50" />
              <div className="w-6 h-6 md:w-6 md:h-6 rounded-[3px] bg-brand-teal/20 border border-brand-teal/10" />
              <div className="w-6 h-6 md:w-6 md:h-6 rounded-[3px] bg-brand-teal/40 border border-brand-teal/30" />
              <div className="w-6 h-6 md:w-6 md:h-6 rounded-[3px] bg-brand-teal/60 border border-brand-teal/50" />
              <div className="w-6 h-6 md:w-6 md:h-6 rounded-[3px] bg-brand-teal shadow-[0_0_10px_rgba(45,212,191,0.5)] border-brand-teal" />
              <span>More</span>
            </div>
          </div>
        </div>
